 ...
 * [httto.yml](httto.yml)
     * Determines how your purl.obolibrary.org/obo/httto/ redirects will be handled
     ...
     * Paste in the contents of [httto.yml](httto.yml)
 ...
 * [httto.md](httto.md)
     ...
     * Paste in the contents of [httto.md](httto.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
